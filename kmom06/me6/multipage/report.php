...
<article>
    <h2>Redovisning kmom05:</h2>
    <p>
        1) Var det lätt att förstå SQL eller kändes det som en helt ny teknik? <br>
        ja, det är väldigt nära mäsnkliga språket. <br>
        liksom:<br><br>
        SELECT * FROM dinasaurs<br><br>
        eller:<br><br>
        INSERT INTO "dinasaurs" VALUES (1,'Triassic',8,5000);<br>
    </p>
    <p>
        2) Var detta din första bekantskap med databaser och SQL, eller har du tidigare kunskaper som du kan relatera till? <br>
        jag har läst sql med php tidigare men använde mysql. sqlite och mysql syntax är nästan samma. förutom man inte behvöer authentication (id, password) när man kopplar till sqlite. sqlite känns mycket mer logisk att använda i enklare program då det är bara en fil och inte en hel mjukvara själv.
    </p>
    <p>
        3) Hur gick det att utföra övningarna med enbart SQLite, var det något du fastnade på? <br>
        det gick bra, har lite bekanskap med sql och pdo seadn tidigare så det gick bra för mig att göra uppgifterana.
    </p>
    <p>
        4) Hur gick det med övningarna i PDO och SQLite, var det något som tog extra mycket tid? <br>
        exampel koderna samt övningen var till hjälp och det gick bara med uppgifterna. Att flytta koderna till me5 under functions och integrera jetty tog lite extra tid för mig. Jag har integrerat data table in i jetty multipage då när man klickar på en länk ska den öppnas under multipage men nöjd med resultatet då den fungerar.
    </p>
    <p>
        5) Gjorde du något extra, utöver det vanliga, i ditt arbete? Berätta gärna om det.
        Nej, inga extra uppgifter då kurs moment 5 är väldigt stort och man knappt hinner med att blir klar med uppgifterna.
    </p>
    <p>
        6) Vilken är din TIL för detta kmom? <br>
        hela sqlite databas var ny för mig. Det är väldigt enkelt och logiskt att använda sqlite. det är väldigt smidigt att flytta på filen av databasen och använda den i olika program. Det är snabbt, inga installation behöbs och fungerar lika som mysql.

    </p>
</article>
<article>
    <h2>Redovisning kmom06:</h2>
    <p>
        1) Fick du hjälp av PHP PDO-artikeln och dess kod, eller skrev du mycket kod själv? <br>
        artikeln var bra, jag skrev mycket själv men fick hjälp av kurs videon med.
    </p>
    <p>
        2) Var det något som var extra svårt eller utmanande i kursmomentet?<br>
        init i me6. hade svårt att droppa och skapa tabeln samtidigt. Fick hjälp av kursvideon och använde loop för att köra de kommandot.
    </p>
    <p>
        3) Nu när kursen närmar sig slutet, känns det som du har kommit in i HTML, CSS, PHP och SQL?<br>
        ja, det var intressanta kursmoment.
    </p>
    <p>
        4) Berätta kort om din syn på din me-sida, är du nöjd med den, eller ser du förbättringspotential? <br>
        det var bra. Men det finns plats för förbättring liksom att alla menylänkar genereras atumatik.
    </p>
    <p>
        5) Gjorde du något extra, utöver det vanliga, i ditt arbete? Berätta gärna om det.<br>
        Nej,
    </p>
    <p>
        6) Vilken är din TIL för detta kmom? <br>
        att man kan skapa list genom att skriva [] framför en variable. liksom: "$sql[]"
    </p>
    <pre>
$sql = [];
